...
[
  {
    ...
    "help": "The universal pixel id, is the id you generated during the universal pixel creation, it looks something like this \u0027a58fde5b-f991-474f-\n9456-b2509ba30042\u0027 .\nSeparate several ids by a comma to add more than one"
  },
  {
    "type": "CHECKBOX",
    "name": "debug",
...
const tracking_ids = data.UNIVERSAL_PIXEL_UUID.split(",");
...
pixie('event', 'PageView', mergedParams);
